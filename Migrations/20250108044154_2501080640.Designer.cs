...
namespace Donate.Migrations
{
    ...
    [Migration("20250108044154_2501080640")]
    partial class _2501080640
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Donate.Data.Entities.ViewDonationItem", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.ToView("ViewDonationItems", (string)null);
                });

            modelBuilder.Entity("Donate.Data.Entities.ViewProject", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.ToView("ViewProjects", (string)null);
                });

            modelBuilder.Entity("Donate.Data.Entities.ViewProjectTask", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ApprovedApplicationCount")
                        .HasColumnType("integer");
                    ...
                    b.ToView("ViewProjectTasks", (string)null);
                });
            ...
            modelBuilder.Entity("Donate.Data.Entities.VolunteerProjectTask", b =>
                {
                    b.Property<int>("VolunteerId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("VolunteerId", "ProjectTaskId");
            ...
            modelBuilder.Entity("Donate.Data.Entities.TaskApplication", b =>
                {
                    b.HasOne("Donate.Data.Entities.ProjectTask", "ProjectTask")
                        .WithMany()
                        .HasForeignKey("ProjectTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Donate.Data.Entities.AppUser", "Volunteer")
                        .WithMany()
            ...
            modelBuilder.Entity("Donate.Data.Entities.VolunteerProjectTask", b =>
                {
                    b.HasOne("Donate.Data.Entities.ProjectTask", "Task")
                        .WithMany()
                        .HasForeignKey("ProjectTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
